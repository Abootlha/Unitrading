    ...
    <div>
        ...
        <div class="container content" id="app">
            <h1 className='h1'>Cookies Policy</h1>
                            <h3 className='heading3'>Introduction</h3><br />
<p class="heading4 font-weight-regular" align="justify">This website (hereinafter called the “<strong>Website</strong>”) which is operated and owned by <strong>General Market Project EOOD</strong>, registered at 121 Prodromou Avenue, Nicosia 2064, Cyprus (hereinafter the “<strong>Company</strong>”).</p><br />
<p class="heading4 font-weight-regular" align="justify">The Company values the privacy of every visitor on the website and takes great effort in maintaining the privacy and the security of each website’s visitor by providing the required security. The provisions of this Cookies Policy (the “<strong>Policy</strong>”) apply to all visitors of the Company’s website and it refers only to cookies.</p><br />
<p class="heading4 font-weight-regular" align="justify">For more information in relation to the collection, processing and protection of your personal data, as well as information regarding your rights, please refer to our <a href="/privacy-policy/">Privacy&nbsp;Policy</a>, which is available on the Website.</p><br />
<p class="heading4 font-weight-regular" align="justify">We reserve the right to update this Policy at any time, and we will provide you with a new data protection policy when we make any substantial updates. We may also notify you in other ways from time to time about the processing of your personal information.</p><br />
<h3 className='heading3'>What are Cookies</h3><br />
...
<h3 className='heading3'>What type of cookies do we use?</h3><br />
...
<h3 className='heading3'>Consent to Cookies</h3><br />
...
<h3 className='heading3'>Use of Cookies</h3><br />
...
<h3 className='heading3'>How can you manage the installation of Cookies?</h3><br />
...
<h3 className='heading3'>CONTACT US</h3><br />
<p class="heading4 font-weight-regular" align="justify">Should you require any further clarification regarding this Cookies Policy, please contact us at <a href="mailto:support@unitrading.io">support@unitrading.io</a>.</p><br /><br />
                    </div>
    </section>
