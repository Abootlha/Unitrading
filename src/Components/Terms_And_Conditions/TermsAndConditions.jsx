...
function TermsAndConditions() {
  return (
    <div>
        ...
        <h3 className="heading3 ">WEBSITE TERMS OF USE</h3><br />
      <p className="heading4 ">By accessing or using the https://unitrading.io/ website (the «site»), you acknowledge and agree to the disclaimers and terms and conditions («terms») set forth below. Please ensure that you (referred to as the «user», «you» or «your» in these Terms and Conditions) read these Terms and Conditions with care. If you do not agree to these Terms and Conditions, you should not use the site. These Terms apply to your use of the site, which is operated and owned by General Market Project EOOD registered at 121 Prodromou Avenue, Nicosia 2064, Cyprus&nbsp;(«UNITrading», «we», and/or «us»).</p><br />
      <p className="heading4 ">You must be 18 years of age to become a member of the UNITrading service. The member who created the UNITrading account and whose Payment Method is charged is referred to here as the «Account Owner» or a «Member» having a «Membership».</p><br />
      <p className="heading4 ">UNITrading reserves the right, in our sole discretion, to change, modify, add or remove portions of these Terms and Conditions at any time by posting the revisions on the site. You should check these Terms periodically for changes as by using the site after we post any changes to these Terms, you are agreeing to accept those changes, whether or not you have reviewed them, and you waive any right you may have to receive individualised notice of such changes.</p><br />
      <p className="heading4 ">By using the site, whether as a guest or a registered user, you agree to be legally bound by these Terms just as if you had signed this agreement. These Terms may be supplemented by additional terms and conditions pertaining to specific content and activities. You agree and understand that such additional terms and conditions are hereby incorporated by reference to these Terms. You are responsible for making all arrangements necessary for you to have access to the site. You are also responsible for ensuring that all persons who access the site through your Internet connection are aware of these Terms, and that they comply with them. From time to time, access to some parts of the site, or the entire site, may be restricted to registered users and further terms and conditions shall apply to such registered users, which the user will be asked to accept within the relevant pages.</p><br />
      <p className="heading4 ">From time to time UNITrading and any of its officers and employees many, to the extent permitted by law, have a position or interest in the instruments – or derivative of instruments – covered directly or indirectly by our reports.</p>
      <h3 className="heading3 ">NO INVESTMENT RECOMMENDATIONS OR ADVICE; RELIANCE ON INFORMATION</h3><br />
      <p className="heading4 ">Our website is a financial education, data portal, and content aggregator. UNITrading is not a broker/dealer, we are not an investment advisor, we have no access to non-public information about publicly traded companies, and this is not a place for the giving or receiving of financial advice, advice concerning investment decisions or tax or legal advice. The services and the information available on or through this site are only for your general information and use and are not intended to address your particular requirements.</p><br />
      <p className="heading4 ">In particular, the investment information, content, education, strategies, alerts, and materials on this site (the «investment information») is in the nature of general investment research and data and is for general informational purposes only. The investment information is not personalised for you or any other recipient, does not constitute any form of advice or recommendation or investment advice by us or other users and is not and should not be considered to be an individualised investment recommendation. Such information is not intended to be relied upon by you in making (or refraining to make) any specific investment or other decisions.</p><br />
      <p className="heading4 ">Appropriate expert independent advice should be obtained before making any such decision. You bear all risks from any use or results of using any services and/or information on this site. UNITrading is an education and research platform for retail traders and investors that specialises in education and producing statistical observations on key financial instruments. These instruments include but are not limited to shares, rolling spot foreign exchange contracts, commodity futures, contract for differences, spread bets, futures and government and public securities.</p><br />
      <p className="heading4 ">We will not arrange any transactions on your behalf. The Investment Information on the site is provided «AS IS» without warranty of any kind. To the maximum extent permitted by applicable law UNITrading is not responsible or liable in any manner for, and makes no representations or warranties of any kind regarding the accuracy, completeness, quality, reliability or usefulness of any investment information or the results obtained from any investment information.</p><br />
      <p className="heading4 ">The type of strategies mentioned on the site may not be suitable for everyone, and you alone are solely responsible for determining whether any investment, strategy or any other product or service is appropriate or suitable for You should consult an independent financial advisor, attorney or tax professional regarding your specific investment, legal or tax situation.</p><br />
      <p className="heading4 ">We may offer valuation tools; these are solely for information and educational purposes so that users can easily run their own valuations. The pre-defined values are simply a starting point based on global assumptions that we have applied across the entire market – you should amend the values as you see fit and not regard them as a substitute for your own judgment. Any resulting valuation outputs are necessarily generic and are not endorsed for a given stock by UNITrading.</p>
      <h3 className="heading3 ">INVESTMENT WARNINGS</h3><br />
      <p className="heading4 ">We would like to draw your attention to the following important investment warnings.</p><br />
      ...
      <p className="heading3 text-uppercase mb-3">INTELLECTUAL PROPERTY</p>
      <p className="heading4 font-weight-regular">
      ...
      <h3 className="heading3 text-uppercase mb-3">THIRD PARTY MATERIALS</h3>
      <p className="heading4 font-weight-regular">
      ...
      <h3 className="heading3 text-uppercase mb-3">ACCOUNT REGISTRATION</h3>
      <p className="heading4 font-weight-regular">
      ...
      <ol>
        ...
        <li>
          <p className="heading4 font-weight-regular">
           c) Maintain and promptly update the Registration Data, and any other information you provide to UNITrading, to keep it accurate, current and complete.
          </p>
        </li>
        <li>
          <p className="heading4 font-weight-regular">
           d) Accept all risks of unauthorised access to the Registration Data and any other information you provide to UNITrading.
          </p><br />
        </li>
      </ol>

      <h3 className="heading3 text-uppercase mb-3">DISCLAIMERS OF WARRANTIES</h3>
      <p className="heading4 font-weight-regular">
      ...
      <h3 className="heading3 text-uppercase mb-3">ADVERTISING</h3>
      <p className="heading4 font-weight-regular">
      ...
      <p className="heading3 text-uppercase mb-3">LIMITATION OF LIABILITY</p>
      <p className="heading4 font-weight-regular">
      ...
      <h3 className="heading3 text-uppercase mb-3">LINKS</h3>
      <p className="heading4 font-weight-regular">
      ...
      <h3 className="heading3 text-uppercase mb-3">GOVERNING LAW</h3>
      <p className="heading4 font-weight-regular">
      ...
      <p className="heading3 text-uppercase mb-3">PRIVACY</p>
      <p className="heading4 font-weight-regular">
      ...
      <h3 className="heading3 text-uppercase mb-3">TERMINATION</h3>
      <p className="heading4 font-weight-regular">
      ...
      <h3 className="heading3 text-uppercase mb-3">ADDITIONAL TERMS</h3>
      <p className="heading4 font-weight-regular">
      ...
      <h3 className="heading3 text-uppercase mb-3">CONTACTING US</h3>
      <p className="heading4 font-weight-regular">
