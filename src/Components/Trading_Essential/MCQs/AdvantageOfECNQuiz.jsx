...
function AdvantageOfECNQuiz() {
    ...
    const quizData = [
      {
        questions: 'While conditions differ for each specific broker, what is NOT something you usually expect from an ECN broker?',
        options: ['After-hour trading','Anonymity','Zero transaction fees','Transparent prices'],
        answer: "Zero transaction fees",
      },
...
export default AdvantageOfECNQuiz