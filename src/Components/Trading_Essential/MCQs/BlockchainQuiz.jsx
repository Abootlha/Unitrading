    ...
    const quizData = [
      {
        ...
        options: ['A series of blocks chained together in a line','A method of selling Bitcoin','A distributed ledger that records all transactions of a cryptocurrency'],
        answer: "A distributed ledger that records all transactions of a cryptocurrency",
      },
