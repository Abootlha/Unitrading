...
function MiningQuiz() {
    ...
    const quizData = [
      {
        questions: 'Cryptocurrency mining is…',
        options: ['One of the methods of validating transactions','The only method of validating transactions','Neither of the above'],
        answer: "One of the methods of validating transactions",
      },
