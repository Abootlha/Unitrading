...
function LeverageAndMarginQuiz() {
    ...
    const quizData = [
      {
        questions: 'What’s the advantage of trading on leverage?',
        options: ['It allows you to give your trades more room to move','It allows you more access to pairs','It increases your buying power'],
        answer: 'It increases your buying power',
      },
...
export default LeverageAndMarginQuiz