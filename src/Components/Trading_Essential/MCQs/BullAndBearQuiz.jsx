...
function BullAndBearQuiz() {
    ...
    const quizData = [
      {
        questions: 'A bull market is when…',
        options: ['Prices are expected to fall','Prices are expected to stay stable','Prices are expected to rise'],
        answer: 'Prices are expected to rise',
      },
...
export default BullAndBearQuiz