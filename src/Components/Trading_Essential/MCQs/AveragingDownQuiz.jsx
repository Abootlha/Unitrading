...
function AveragingDownQuiz() {
    ...
    const quizData = [
      {
        questions: 'Averaging down means…',
        options: ['Increasing the size of a losing position','Reducing the size of a losing position by half'],
        answer: "Increasing the size of a losing position",
      },
...
export default AveragingDownQuiz