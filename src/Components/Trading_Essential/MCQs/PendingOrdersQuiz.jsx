...
function PendingOrdersQuiz() {
    ...
    const quizData = [
      {
        questions: 'A pending order is placed when a trader wants a position to be ____ when a security reaches a certain price.',
        options: ['Opened','Closed','Modified'],
        answer: 'Opened',
      },
...
export default PendingOrdersQuiz