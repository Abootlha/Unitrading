...
function BalanceAndEquityQuiz() {
    ...
    const quizData = [
      {
        questions: 'Balance is the outcome of…',
        options: ['Currently open positions','Closed positions','Open and closed positions'],
...
export default BalanceAndEquityQuiz